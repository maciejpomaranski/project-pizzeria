...
class Booking{
  ...
  initTables(event){
    ...
    const table = event.classList.value.includes('table');
    const bookedTable =  event.classList.value.includes(classNames.booking.tableBooked);
    ...
    if((tableId && table) && !bookedTable){
      ...
      if(event.classList.value.includes(classNames.booking.tableSelected)){
        thisBooking.unselectTables();
        thisBooking.selectedTable = '';
